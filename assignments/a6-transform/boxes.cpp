...
public:
   ...
   void scene()
   {
      // Question 1 - B1
      vec3 d10 = vec3(-2, 0 ,1);
      quat R10 = glm::angleAxis(0.f, vec3(0,0,1));
      ...
      // Question 1 - B2
      vec3 d20 = vec3(4, 0, 2);
      quat R20 = glm::angleAxis((float)M_PI/4, vec3(0,0,1));
      ...
      // Question 1 - B3
      vec3 d30 = vec3(5, 4, 2);
      quat R30 = glm::angleAxis((float)M_PI/2, vec3(0,0,1));
      ...
      quat tmp = glm::angleAxis(0.f, vec3(0,0,1));
      Transform aa(tmp, vec3(0, 2, 0));
      //Transform F(glm::angleAxis((float)-M_PI/4, vec3(0,0,1)),vec3(-4.828, 2, -1))
      Transform F = aa * F10 * F20.inverse();
